...
cf_resources=$(
  jq -n \
    ...
    '
    {
      ...
      "backup-prepare": {"instances": 0, "internet_connected": $internet_connected},
      ...
      "service-discovery-controller": {"instances": 1, "internet_connected": $internet_connected},
      ...
      "diego_cell": {"instances": 1, "internet_connected": $internet_connected},
      ...
      "credhub": {"instances": 0, "internet_connected": $internet_connected}
    }
